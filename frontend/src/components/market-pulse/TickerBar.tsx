      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 font-mono">
          ...
          <button
            ...
            className="rounded-full border border-[#2b5260] bg-[#0f766e]/20 px-3 py-2 text-[10px] uppercase tracking-[0.22em] text-[#5eead4] transition-colors hover:bg-[#0f766e]/30"
          >
            Refresh
          </button>
        </div>
