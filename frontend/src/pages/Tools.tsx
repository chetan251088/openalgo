...
const tools = [
  ...
  },
  {
    ...
    description: 'AI Scalper performance analytics with equity curve, win rate, and trade breakdown',
    href: '/auto-trade/analytics',
    color: 'bg-purple-500',
  },
  {
    title: 'Auto-Trade Model Tuning',
    description: 'AI-powered strategy optimization with LLM recommendations and auto-apply',
    href: '/auto-trade/model-tuning',
    color: 'bg-fuchsia-500',
  },
  {
    title: 'Manual Trade Analytics',
    description: 'Manual scalping performance metrics with trade logs and analytics',
